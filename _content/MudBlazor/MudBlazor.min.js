...
let boundingRect=popoverNode.parentNode.getBoundingClientRect();if(classList.contains('mud-popover-relative-width')){popoverContentNode.style['max-width']=(boundingRect.width)+'px';}
