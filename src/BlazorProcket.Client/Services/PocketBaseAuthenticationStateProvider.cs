...
public class PocketBaseAuthenticationStateProvider : AuthenticationStateProvider
{
    ...
    private readonly BlazorProcketApplication _pocketBase;
    private readonly ILocalStorageService _localStorage;

    public PocketBaseAuthenticationStateProvider(BlazorProcketApplication pocketBase, ILocalStorageService localStorage)
    {
